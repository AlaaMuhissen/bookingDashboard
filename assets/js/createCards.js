...
export function createCards(isCart , arr  , index){
    ...
    firstLine.id = index;
    rating.id = "rating";
    rating.textContent = arr.rating;
    review.textContent = " Very Good ";
    review.id= "review";
    reviewNum.textContent = `${arr.reviewsNum} reviews`;
    
    SecondLine.className = "time-line";
    checkBox.type = "checkbox";
    checkBox.id ="check";
    time.textContent = arr.departureTime;
    time.id = "time";
    ...
    feedBackSec.appendChild(reviewNum);
